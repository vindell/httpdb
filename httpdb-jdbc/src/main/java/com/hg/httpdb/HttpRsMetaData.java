...
public class HttpRsMetaData implements ResultSetMetaData {
	...
	private List<ColumnType> fields;

	public HttpRsMetaData(List<ColumnType> fields) {
		this.fields = fields;
	}
	...
	private ColumnType getField(int column) throws SQLException {
		if (column <= this.fields.size()) {
			return (ColumnType) this.fields.get(column - 1);
		} else {
