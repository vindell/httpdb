...
import org.httpdb.utils.ArrayUtils;
...
public class ResultMetaData {
	 ...
	 public static final int RESULT_METADATA          = 1;
	    ...
	    public static ResultMetaData newUpdateResultMetaData(ColumnType[] types) {

	        ResultMetaData md = new ResultMetaData(UPDATE_RESULT_METADATA);

	        md.columnTypes         = new ColumnType[types.length];
	        md.columnCount         = types.length;
	        md.extendedColumnCount = types.length;

	        ArrayUtils.copyArray(types, md.columnTypes, types.length);
