...
import com.hg.httpdb.Crypt;
import com.hg.httpdb.DataIO;
import com.hg.httpdb.HttpConnection;
import com.hg.httpdb.HttpResultSet;
import com.hg.httpdb.HttpStatement;
import com.jeefw.jeekit.httpconn.HttpConnectionUtils;
import com.jeefw.jeekit.httpconn.handler.ResponseHandler;
 ...
 * *******************************************************************
 */
public class CopyOfHttpdbStatement implements Statement {
	...
	public CopyOfHttpdbStatement(HttpConnection conn) {
		this.conn = conn;
	}
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		...
		try {
			...
			httpConn = (HttpURLConnection) new URL().openConnection();
